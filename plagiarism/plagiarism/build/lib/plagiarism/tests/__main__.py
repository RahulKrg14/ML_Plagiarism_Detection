...
from plagiarism import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('plagiarism')
...
def main(args=None):
    """
    Called with ``python -m plagiarism.tests``: run main test suite.
    """
    ...
    import plagiarism.tests as test_module
